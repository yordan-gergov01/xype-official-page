    ...
    <section id="research" style={{ backgroundColor: '#0C0C0C' }} className="py-24 px-6">
      <div className="max-w-[560px] mx-auto">
        ...
        <p className="mt-3" style={{ fontSize: 14, lineHeight: 1.7, color: '#555555' }}>
          Не продаваме нищо. Правим проучване на реалните предизвикателства на българския бизнес.
          Вашият отговор ни помага да разберем къде AI може да има истинска стойност.
        </p>
        <ResearchForm />
      </div>
    </section>
